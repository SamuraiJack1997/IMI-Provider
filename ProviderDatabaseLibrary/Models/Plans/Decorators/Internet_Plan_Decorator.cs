...
{
    public class Internet_Plan_Decorator : Internet_Plan
    {
        private readonly Internet_Plan plan;
        public Internet_Plan_Decorator(Internet_Plan plan) : base(plan.ID, plan.Name, plan.Price, plan.Internet_Plan_ID, plan.TV_Plan_ID, plan.Combo_Plan_ID, plan.Download_Speed, plan.Upload_Speed)
        {
            this.plan = plan;
        }
